...
class AgentEngineApp(AdkApp):
    ...
    async def query(
        ...
        **kwargs,
        ...
        """Non-streaming query method to support the :query REST endpoint."""
        import json
        ...
        if isinstance(message, str):
            try:
                ...
                if isinstance(parsed, dict) and "data" not in parsed:
                    normalized_message = json.dumps({"data": parsed})
            except Exception:
                normalized_message = json.dumps({"data": message})
        elif isinstance(message, dict):
            if "data" not in message:
                normalized_message = {"data": message}
